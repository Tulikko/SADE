...
seal$ID <- c(1:nrow(coin))
notseal$ID <- c(1:nrow(notcoin))
...
# Wards method (HCA) 
PCA.ward <- hclust(dist(PCA.st, method="euclid"), method="ward")
plot(PCA.ward, main="Ward's method")
rect.hclust(PCA.ward, k=5)
